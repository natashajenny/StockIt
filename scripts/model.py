...
class StockLog(Model, Base):
    ...
    sma15 = Column('sma15', Numeric)
    sma50 = Column('sma50', Numeric)
    sma200 = Column('sma200', Numeric)
    ema15 = Column('ema15', Numeric)
    ema50 = Column('ema50', Numeric)
    ema200 = Column('ema200', Numeric)    
    macd = Column('macd', Numeric)
    macd_sig = Column('macd_sig', Numeric)
    macd_hist = Column('macd_hist', Numeric)
    bb_hi = Column('bb_hi', Numeric)
    bb_mid = Column('bb_mid', Numeric)
    bb_lo = Column('bb_lo', Numeric)
    slowk = Column('slowk', Numeric)
    slowd = Column('slowd', Numeric)
    rsi = Column('rsi', Numeric)
    adx = Column('adx', Numeric)
    cci = Column('cci', Numeric)
    aroon_dn = Column('aroon_dn', Numeric)
    aroon_up = Column('aroon_up', Numeric)
    chaikin = Column('chaikin', Numeric)
    obv = Column('obv', Numeric)
    mom = Column('mom', Numeric)    
    pe_ratio = Column('pe_ratio', Numeric)
    dp_ratio = Column('dp_ratio', Numeric)
    pb_ratio = Column('pb_ratio', Numeric)    
